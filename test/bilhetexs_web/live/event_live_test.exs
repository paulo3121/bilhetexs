defmodule BilhetexsWeb.EventLiveTest do
  use BilhetexsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Bilhetexs.EventsFixtures

  @create_attrs %{name: "some name", status: "some status", date: "2025-07-09T22:59:00Z", description: "some description"}
  @update_attrs %{name: "some updated name", status: "some updated status", date: "2025-07-10T22:59:00Z", description: "some updated description"}
